...
<div class="row mb-4">
    <div class="col-12">
        ...
        <h3 class="fw-bold">Edit Data Program Studi</h3>
        <p class="text-muted mb-0">Perbarui informasi data program studi</p>
    </div>
</div>
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-warning py-3">
                <h5 class="mb-0 fw-semibold">Form Edit Program Studi</h5>
            </div>
            <div class="card-body p-4">
                <form action="program_studi/proses.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control form-control-lg" value="<?= $data['nama_prodi']; ?>" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="jenjang" class="form-select form-select-lg" required>
                            ...
                            <option value="D2" <?= $data['jenjang']=='D2'?'selected':''; ?>>D2 (Diploma Dua)</option>
                            <option value="D3" <?= $data['jenjang']=='D3'?'selected':''; ?>>D3 (Diploma Tiga)</option>
                            <option value="D4" <?= $data['jenjang']=='D4'?'selected':''; ?>>D4 (Diploma Empat / Sarjana Terapan)</option>
                            <option value="S2" <?= $data['jenjang']=='S2'?'selected':''; ?>>S2 (Magister)</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="akreditasi" class="form-select form-select-lg" required>
                            <option value="">-- Pilih Akreditasi --</option>
                            <option value="Unggul" <?= $data['akreditasi']=='Unggul'?'selected':''; ?>>Unggul</option>
                            <option value="A" <?= $data['akreditasi']=='A'?'selected':''; ?>>A (Sangat Baik)</option>
                            <option value="Baik Sekali" <?= $data['akreditasi']=='Baik Sekali'?'selected':''; ?>>Baik Sekali</option>
                            <option value="B" <?= $data['akreditasi']=='B'?'selected':''; ?>>B (Baik)</option>
                            <option value="C" <?= $data['akreditasi']=='C'?'selected':''; ?>>C (Cukup)</option>
                            <option value="Dalam Proses" <?= $data['akreditasi']=='Dalam Proses'?'selected':''; ?>>Dalam Proses Akreditasi</option>
                        </select>
                    </div>
        ...
        <div class="card border-0 bg-light">
            <div class="card-body p-4">
                ...
                <ul class="small mb-0">
                    ...
                    <li class="mb-2">Perubahan akan mempengaruhi data mahasiswa terkait</li>
